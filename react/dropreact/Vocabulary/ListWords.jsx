...
export default class ListWords extends React.Component {
    constructor(props) {
        ...
        this.SearchNull = this.SearchNull.bind(this);
        this.SearchWords = this.SearchWords.bind(this);
    }

    SearchNull(inp) {
        // console.log("SearchNull,input:", inp);
        if (inp === '') {
            <div>Какое слово перевести? Введи!</div>
            //return this.state.words.map((e, j) => { return <ValueWords key={j}>{e}</ValueWords> }) 
        }
        else return this.SearchWords(inp)
    }
    //console.log("GO");

    SearchWords(str) {
        let i, end;
        // console.log("SearchWords,str.substr(0, 1):", strsl);
        //if (strsl == this.state.ABC[0]) { i = 0, end = 542 }
        // console.log("SearchWordsIF,i,end:", i, end);
        //for (let j = 0; j <= Object.keys(this.state.ABC).length; j++) {
        switch (str.slice(0, 1)) {
            case this.state.ABC[0]: i = 0, end = 542; break;
            case this.state.ABC[1]: i = 542, end = 1025; break;
            case this.state.ABC[2]: i = 1025, end = 1784; break;
            case this.state.ABC[3]: i = 1784, end = 2297; break;
            case this.state.ABC[4]: i = 2297, end = 2653; break;
            case this.state.ABC[5]: i = 2653, end = 3057; break;
            case this.state.ABC[6]: i = 3057, end = 3308; break;
            case this.state.ABC[7]: i = 3308, end = 3618; break;
            case this.state.ABC[8]: i = 3618, end = 3925; break;
            case this.state.ABC[9]: i = 3925, end = 4004; break;
            case this.state.ABC[10]: i = 4004, end = 4057; break;
            case this.state.ABC[11]: i = 4057, end = 4318; break;
            case this.state.ABC[12]: i = 4318, end = 4684; break;
            case this.state.ABC[13]: i = 4684, end = 4838; break;
            case this.state.ABC[14]: i = 4838, end = 5013; break;
            case this.state.ABC[15]: i = 5013, end = 5623; break;
            case this.state.ABC[16]: i = 5623, end = 5653; break;
            case this.state.ABC[17]: i = 5653, end = 6100; break;
            case this.state.ABC[18]: i = 6100, end = 7038; break;
            case this.state.ABC[19]: i = 7038, end = 7459; break;
            case this.state.ABC[20]: i = 7459, end = 7581; break;
            case this.state.ABC[21]: i = 7581, end = 7698; break;
            case this.state.ABC[22]: i = 7698, end = 7963; break;
            case this.state.ABC[23]: i = 7963, end = 7992; break;
            case this.state.ABC[24]: i = 7992, end = 7999; break;
            default: console.log("Error: Switch case default");
        }
        // console.log("SearchWords,i,end:", i, end);
        //console.log("SearchWords,wrods.length:", Object.keys(this.state.words).length);
        for (i; i <= end; i++) {
            // console.log("SearchWords,words[i][0]]:", this.state.words[i][0]);
            // console.log("SearchWords,str:", str);
            // console.log("SearchWords,i:", i);
            if (str === this.state.words[i][0]) {
                // console.log("SearchWords,ValueWord:", this.state.words[i][1]);
                return this.state.ValueWord = this.state.words[i][1]
            }
        }
        return this.state.ValueWord = "404: Not found :D";
    }

    render() {
        return (
            <DivList>
                <WordsP>Translation of a word</WordsP>
                <ValueWords >{this.SearchNull(this.props.inp)}</ValueWords >
            </DivList >
        )
    }
}
